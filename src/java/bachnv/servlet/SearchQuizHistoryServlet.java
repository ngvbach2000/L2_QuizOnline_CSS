        ...
        try {
            ...
            if (searchValue != null) {
                ...
                if (email != null) {
                    ...
                    quizDAO.searchQuizBySubjectName(searchValue, email, (page - 1) * RECORDS_PER_PAGE, RECORDS_PER_PAGE);
                    noOfRecords = quizDAO.getRecordsSearchQuizBySubjectName(searchValue, email);
            ...
            log("Search Quiz History _ SQL " + ex.getMessage());
        } catch (NamingException ex) {
            log("Search Quiz History _ Naming " + ex.getMessage());
        } finally {
